...
;; Flymake general
(require 'flymake)
(setq flymake-run-in-place nil) ; nice default when using tramp; use .dir-locals.el to override
...
;; Flymake for bash
(when (load "flymake" t)
  (defun flymake-shellscript-init ()
    (let* ((temp-file (flymake-init-create-temp-buffer-copy
               'flymake-create-temp-inplace))
       (local-file (file-relative-name
            temp-file
            (file-name-directory buffer-file-name))))
      (list "shellcheck" (list "--format=gcc" "-x" local-file))))
   (add-to-list 'flymake-allowed-file-name-masks
             '("\\.sh\\'" flymake-shellscript-init)))

;; Flymake for ELisp
;; This appears to be from: https://www.emacswiki.org/emacs/FlymakeElisp
...
(defun flymake-get-tex-args (file-name)
    (list "chktex" (list "-g" "-l" (expand-file-name "~/.chktexrc") "-q" "-v0" "-I" "-x" file-name)))
(push
 '("^\\(\.+\.tex\\):\\([0-9]+\\):\\([0-9]+\\):\\(.+\\)"
...
(custom-set-variables
 ...
 '(git-commit-kill-buffer-hook (quote (git-commit-save-message)))
 ...
 '(package-selected-packages
   (quote
    (zenburn-theme yasnippet yaml-mode yagist unicode-fonts ujelly-theme twilight-theme twilight-anti-bright-theme subatomic-enhanced-theme sr-speedbar smartparens smart-tab pdf-tools pastels-on-dark-theme osx-trash osx-pseudo-daemon osx-location osx-clipboard org-plus-contrib org-mobile-sync org-magit org-gcal org-bullets org-ac markdown-toc magit-svn magit-find-file macro-math logito imenus imenu-list imenu-anywhere imenu+ idle-require highlight-parentheses hideshowvis graphviz-dot-mode gitty gitignore-mode github-theme github-browse-file gitconfig-mode gitattributes-mode git-messenger git-link gh-md fortpy flymake-shell flymake exec-path-from-shell espresso-theme dired-toggle dired-single dired-imenu dired-details cmake-mode browse-at-remote auctex ag)))
