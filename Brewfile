...
brew "ykpers"
# Command-line tool for the YubiKey NEO PIV applet
...
# Compatibility library for Emacs 24's cl-lib
...
# Emacs major mode for editing JSON
...
brew "dunn/emacs/smartparens"
# Emacs web browser
brew "dunn/emacs/w3"
# Emacs package for displaying available keybindings
